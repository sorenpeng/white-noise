...
export default function Home() {
  ...
  const { state: audioState, updateParameters, togglePlayback, isInitialized } = useAudioEngine()
  ...
  useEffect(() => {
    ...
    ritualState.emotionParams,
    ritualState.currentState,
    updateParameters,
    togglePlayback,
        ...
        return (
          <div className="flex flex-col items-center justify-center h-full text-center px-8">
            <BreathingText
              ...
              className="mb-8"
            />
            <p className="text-white/60 text-lg max-w-md">在屏幕上画出一条线，表达你此刻的情绪</p>
  ...
  return (
    ...
    >
      ...
      {/* 主要内容区域，包含状态文本等 */}
      <div className="relative z-20 w-full h-full">{renderContent()}</div>
